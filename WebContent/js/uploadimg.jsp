...
<LINK 
href="/fzsalessys/admin/images/syscome.files/Admin.css" rel=stylesheet>
<SCRIPT language=javascript src="/fzsalessys/admin/images/syscome.files/Admin.js"></SCRIPT>
...
if(filename!=null)
{
 ...
 txt.src="/fzsalessys/upfile/<%=filename%>";
 popclose();
 </script>
 <%} %>
<form action="/fzsalessys/fzsalessys?ac=uploadimg" enctype="multipart/form-data" name="f1" method="post">
...
if(suc!=null)
{
 %>
 alert("操作成功");
  parent.location.replace("/fzsalessys/admin/kcfiles.jsp");
 <%}%>
 </script>
