...
function uploadimg()
{
pop("/fzsalessys/js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("/fzsalessys/js/uploadimg2.jsp","上传图片",300,77)
}

function uploaddoc()
{
pop("/fzsalessys/js/uploaddoc.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/fzsalessys/js/dialogclose.gif  />';
