          ...
          <TD  background=fzsalessys_files/all.jpg>
           ...
           <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                    ...
                    <TR>
                      ...
                      <TD class=green_title01>商品对比</TD>
                      <TD width=50>
                      <DIV align=center><A 
              ...
              <TR>
                <TD vAlign=top>
                  <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                    ...
                    String sql = "select * from pros where id in("+pids+")   ";
                      
                    sql+="order by id desc";
                    
                     PageManager pageManager = PageManager.getPage("pmore.jsp?1=1", 90, request);
                          ...
                          <TR>
                            <TD vAlign=top>
                              ...
                              width="100%">
                                ...
                                <TR>
                                <TD 
                                width="33%" rowspan="4" align=center vAlign="top" bgColor=#ffffff>
                                ...
                                <TR>
                                <TD width="67%" height="26" 
                                align=left vAlign=center bgColor=#ffffff><%=m.get("extbei").toString().replaceAll("@","<br />") %></TD>
                                </TR>
