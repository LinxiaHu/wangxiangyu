...
<script language=javascript src="/fzsalessys/admin/js/outlook.js"></script>
<%
String admin = "";
String utype = "";
...
<div id="sub_info" >&nbsp;&nbsp;  &nbsp;<span id="show_text">欢迎来到服装商城<%=Info.getUser(request).get("utype") %>中心</span></div>
</body>
</html>
